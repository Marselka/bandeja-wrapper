...
def main():
    ...
    resulting_offset_s = (np.mean(
        sm_gyro_time - mcu_gyro_time) + comp_delay2)  # resulting_offset_s = (sm_gyro_time[0] - mcu_gyro_time[0] + comp_delay2)
